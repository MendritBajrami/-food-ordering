  ...
  return (
    <Link href={`/menu/${product.id}`}>
      <motion.div
        ...
        className="bg-white rounded-[2rem] shadow-sm hover:shadow-2xl hover:shadow-red-500/10 transition-all duration-500 group border border-gray-100/50 overflow-hidden cursor-pointer h-full"
      >
        ...
        <div className="p-6 h-[calc(100%-16rem)] flex flex-col justify-between">
          ...
          <div className="flex items-center justify-between pt-2 border-t border-gray-50">
            ...
            <motion.button
              whileTap={{ scale: 0.9 }}
              onClick={handleAdd}
              className={`flex items-center gap-2 px-6 py-3 rounded-2xl font-bold transition-all duration-300 z-10 ${
                isAdding
